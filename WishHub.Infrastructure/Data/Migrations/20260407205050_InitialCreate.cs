        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WishlistPrivacy = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomName = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    IsReserved = table.Column<bool>(type: "boolean", nullable: false),
                    ReservedById = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WishlistItems_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WishlistItems_AspNetUsers_ReservedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalLogins_Provider_ExternalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_OwnerId_ProductId",
                table: "WishlistItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_ReservedById",
                table: "WishlistItems",
                column: "ReservedById");
        }
